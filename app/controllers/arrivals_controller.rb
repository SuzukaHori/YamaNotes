...
class ArrivalsController < ApplicationController
  ...
  def create
    ...
    if @arrival.save
      ...
      redirect_to walk_path(current_walk), alert: t('flash.arrivals.create.error')
    end
  end
  ...
  def update
    ...
    if @arrival.save
      flash.now.notice = t('flash.arrivals.update.success')
    else
  ...
  def set_walk
    ...
    redirect_to root_path, alert: t('flash.arrivals.not_found')
  end
